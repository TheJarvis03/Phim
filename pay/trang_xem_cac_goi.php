...
<?php include('../layout/menu.php'); ?>
    ...
    <div class="noidungtongquat">
        <h1 style="margin-left: 33%; border: 1px; background-color: #778899; display: inline; padding: auto">Chọn gói dịch vụ phù hợp với bạn</h1>
        <div class="TQ">
            <?php
            ...
            <div class="T1">
                <table>
                    <tr>
                        <td><h3 style="color: black; text-align: center"><?php echo $row['ten']; ?></h3></td>
                    </tr>
                    <tr>
